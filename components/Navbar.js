...
import { StyledNavbar_1, StyledNavbar_2, StyledNavbar_3, StyledNavbar_4, StyledNavbar_5, StyledNavbar_6, StyledNavbar_7 } from '../components/styles/Navbar.styled';
import { NavLinkList_1, NavLinkList_2, NavLinkList_3, NavLinkList_4, NavLinkList_5, NavLinkList_6, NavLinkList_7 } from '../components/styles/NavbarLinkList.styled';
import { NavNewsletterSubscribe } from './NewsletterSubscribe';
import { PrimaryLink, PrimaryLinkLg, PrimaryLinkMd, PrimaryLinkSm, PrimaryLinkXs } from "./styles/StyledLink.styled";
...
const NavLinks = ({ openMenu, components, onClick }) => {
    ...
    return (
        <CC openMenu={openMenu}>
            <li><LC onClick={onClick} href="/about">about</LC></li>
            <li><LC onClick={onClick} href="/comics">comics</LC></li>
            <li><LC onClick={onClick} href="/collectibles">collectibles</LC></li>
            <li><LC onClick={onClick} href="/characters">characters</LC></li>
            <li><LC onClick={onClick} href="/artists">artists</LC></li>
            <li><LC onClick={onClick} href="/news">news</LC></li>
            <li><LC onClick={onClick} href="/merch">merch</LC></li>
            <li>
...
export const Navbar_Style_4 = () => {
    ...
    return (
        <StyledNavbar_4>
            <NavBrand />
            <HamburgerMenu.Wrapper onClick={() => toggleMenu(!openMenu)}>
                {openMenu ? <HamburgerMenu.CloseMenuIcon_1 /> : <HamburgerMenu.OpenMenuIcon_4 />}
            </HamburgerMenu.Wrapper>
            <NavLinks openMenu={openMenu} components={components} onClick={() => toggleMenu(false)}/>
            <NavNewsletterSubscribe />
        </StyledNavbar_4>
...
export const Navbar_Style_5 = () => {
    ...
    return (
        <StyledNavbar_5>
            <NavBrand />
            <HamburgerMenu.Wrapper onClick={() => toggleMenu(!openMenu)}>
                {openMenu ? <HamburgerMenu.CloseMenuIcon_1/> : <HamburgerMenu.OpenMenuIcon_5 />}
            </HamburgerMenu.Wrapper>
            <NavLinks openMenu={openMenu} components={components} onClick={() => toggleMenu(false)}/>
            <NavNewsletterSubscribe />
        </StyledNavbar_5>
